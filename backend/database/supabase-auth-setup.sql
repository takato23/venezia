...
-- 3. Actualizar tabla users para que funcione con auth
ALTER TABLE users ALTER COLUMN id TYPE UUID USING id::uuid;

-- 4. Habilitar RLS en todas las tablas importantes
...
-- IMPORTANTE: Primero debes crear un usuario desde el dashboard de Supabase Auth
-- con el email admin@venezia.com y contraseña admin123
